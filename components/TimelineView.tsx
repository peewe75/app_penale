...
import { Clock, AlertTriangle, Shield, User, Info } from 'lucide-react';
                  ...
                  <div key={index} className="relative flex gap-8 group">
                    ...
                    >
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <span className="text-[10px] text-navy-500 uppercase tracking-widest font-bold group-hover:text-white">
                          Vai al minuto {'->'}
                        </span>
                      </div>
                      <p className="text-sm text-navy-400 leading-relaxed font-light">{item.desc}</p>
                    </div>
                  </div>
                ))}
              </div>
